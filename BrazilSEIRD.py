...
total_recoveries_Brazil = total_recoveries_Brazil.tolist()
total_deaths_Brazil = total_deaths_Brazil.tolist()
total_active_cases_Brazil = total_active_cases_Brazil.tolist()
data1 = pd.DataFrame({'I':total_active_cases_Brazil,'R':total_recoveries_Brazil,'D':total_deaths_Brazil})
...
print("-----------------------------------------------------------")
print("The number of deaths on 11/23 according to the model is " + np.str(np.around(final[272,2])))
